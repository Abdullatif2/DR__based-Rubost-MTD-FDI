...
td3_4_n = f'Output/td3/perturb_all_lines_ratio_0.3/with_ep_schdlr_ptienc_2_0.001_0.001_dropout_03_first_2_layers_old_noise/score_plot/score_history.npy'
...
ddpg_4_fr = f'Output/ddpg/minimum_full_rank_ratio_0.3/with_ep_schdlr_ptienc_2_0.001_0.001_dropout_03_first_2_layers/score_plot/score_history.npy'
ddpg_4_score_fr = load_score_history(ddpg_4_fr)

td3_4_n_fr = f'Output/td3/minimum_full_rank_ratio_0.3/with_ep_schdlr_ptienc_2_0.001_0.001_dropout_03_first_2_layers_old_noise/score_plot/score_history.npy'
td3_4_n_score_fr = load_score_history(td3_4_n_fr)
...
ax.plot(ddpg_4_score_fr, color=plt.cm.tab10(3), linestyle='-', lw=2.5, label="DDPG")
ax.plot(td3_4_n_score_fr, color=plt.cm.tab10(0), linestyle='-', lw=2.5, label="TD3")
...
fig.savefig(f"{output_dir}/temp_FR_reward_plot_{train_config['ratio']}_.pdf", bbox_inches="tight", dpi=400)
